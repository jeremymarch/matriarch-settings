...
impl GenericOptions for ParamListOption {
    fn get_options(&self) -> Vec<String> {
        ...
        a.into_iter().enumerate().map(|(idx, r)| { if idx == self.default_index { format!("{} (Default{})", r, if !self.default_mesg.is_empty() { format!(" – {}", self.default_mesg)} else { String::from("") }) } else { r.to_string() } }).collect::<Vec<String>>()
    }
    fn get_name(&self) -> String {
        self.name.to_owned()
    }
...
static params:[Box<dyn GenericOptions + Sync>; MAX_PARAM] = [
    ...
    Box::new(ParamListOption {
        id:2, 
        name:"Knob Mode", 
        options:vec!["Snap", "Pass-Thru", "Relative"],
        default_index:0,
        default_mesg: "",
        note: "Actual default different to documented"}),
    Box::new(ParamListOption {
        id:3, 
        name:"Note Priority", 
        options:vec!["Low", "High", "Last Note"],
        default_index:2,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["none", "DIN only", "USB only", "Both DIN and USB"],
        default_index:3,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Off", "Echo USB In to DIN Out", "Echo USB In to USB Out", "Echo DIN In to Both DIN and USB Out"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
        ...
        options:vec!["Off", "Echo DIN In to DIN Out", "Echo DIN In to USB Out", "Echo DIN In to Both DIN and USB Out"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamRangeOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Relative to First Note", "Relative to Middle C"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Don't Repeat end notes", "Repeat end notes"],
        default_index:1,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
        id:23, 
        name:"Arp/Seq Swing",
        options:vec!["Slider", "Slider"],
        default_index:0,
        default_mesg: "",
        note: ""}), //Slider(819, 15565, 8192)
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Clock", "Step-Advance Trigger"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
        ...
        options:vec!["Always", "Only When Playing"],
        default_index:1,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Off", "On When Playing"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["1 PPQN", "2 PPQN", "3 PPQN", "4 PPQN", "5 PPQN", "6 PPQN", "7 PPQN", "8 PPQN", "9 PPQN", "10 PPQN", "11 PPQN", "12 PPQN", "24 PPQN", "48 PPQN"],
        default_index:3,
        default_mesg: "sixteenth notes",
        note: ""}),
    Box::new(ParamListOption {
        id:36, 
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["-2", "-1", "0", "1", "2"],
        default_index:2,
        default_mesg: "no transpose",
        note: ""}),
    Box::new(ParamListOption {
        id:39, 
        name:"Delayed Keyboard Octave Transpose",
        options:vec!["Off", "On"],
        default_index:1,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
        id:40, 
        name:"Glide Type",
        options:vec!["Linear Constant Rate", "Linear Constant Time", "Exponential"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["-5V to +5V", "0V to 10V"],
        default_index:0,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        options:vec!["Off", "First-Note Reset", "On"],
        default_index:1,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
    ...
    Box::new(ParamListOption {
        ...
        default_index:0,
        default_mesg: "",
        note: "Actual default different to documented"}), //Slider(0, 16383, 0)
/* new Param(71, "Noise Filter Cutoff", Slider(0, 16383, 0), "Actual default different to documented"),*/
    Box::new(ParamListOption {
        id:72, 
        name:"Arp/Seq Random Repeats",
        options:vec!["no repeating notes/steps in RND direction", "allow repeating notes (true random)"],
        default_index:1,
        default_mesg: "",
        note: ""}),
    Box::new(ParamListOption {
